 ...
 * 
 */
public class ExitParkingClientImpl extends UnicastRemoteObject implements RemoteObserver {
	ExitParkingMainUI exitParkingMainUI;
	private static final long serialVersionUID = 1L;

	protected ExitParkingClientImpl(ParkingServerInterface psi) throws RemoteException {
		super();
