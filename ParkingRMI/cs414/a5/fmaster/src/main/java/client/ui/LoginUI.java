...
public class LoginUI {
	...
	private LoginUI(MainUI mainUI, ParkingServerInterface parking) {
		this.mainUI = mainUI;
		this.parking = parking;
	}

	public static LoginUI getInstance(MainUI mainUI, ParkingServerInterface parking) {
		if (instance == null) {
			instance = new LoginUI(mainUI, parking);
		}
		return instance;
	}
