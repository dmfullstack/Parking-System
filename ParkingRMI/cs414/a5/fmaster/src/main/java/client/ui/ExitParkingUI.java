...
public class ExitParkingUI {
	...
	private ExitParkingUI(MainUI mainUI, ParkingServerInterface parking) {
		this.mainUI = mainUI;
		this.parking = parking;
	}

	public static ExitParkingUI getInstance(MainUI mainUI, ParkingServerInterface parking) {
		if (instance == null) {
			instance = new ExitParkingUI(mainUI, parking);
		}
		return instance;
	}
	...
	public void setupUI() throws RemoteException {
		...
		mainUI.addGridBagComponent(payment2, new JLabel("Exparkingration Date: "), GridBagConstraints.BOTH, 0, 4);
