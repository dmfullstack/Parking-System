 ...
 * 
 */
public class AdminParkingClientImpl extends UnicastRemoteObject implements RemoteObserver {
	AdminMainUI adminMainUI;
	private static final long serialVersionUID = 1L;

	protected AdminParkingClientImpl(ParkingServerInterface psi) throws RemoteException {
		super();
